...
namespace Laikos
{
    class DefferedRenderer
    {
        ...
        private void Debug()
        {
            ...
            Rectangle rect = new Rectangle(128, 0, width, height);
            ...
            spriteBatch.DrawString(font, "FPS: " + (1000 / (gameTime.ElapsedGameTime.Milliseconds > 0 ? gameTime.ElapsedGameTime.Milliseconds : 1000)), new Vector2(138.0f, 20.0f), Color.White);
            //End SpriteBatch
            spriteBatch.End();
        }
        ...
        private void DrawLights(List<GameObject> objects)
        {
            ...
            if (lights.getSpotLights().Count > 0)
            {
